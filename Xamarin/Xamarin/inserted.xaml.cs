        ...
        private async void week_selectClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var loc1 in result1)
                {
                    ...
                    dd4 = dd2.Month;
                    dd5 = dd2.Year;
                    if (loc1.Name == "食費" && (dd3 <= a && dd3 > a - 8) && dd4 == c && dd5 == b)
                        this.c1 = loc1.Spay + this.c1;
                }
                a1.Text = ("食費:" + this.c1+"円");
